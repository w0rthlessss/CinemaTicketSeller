...
CREATE TABLE `cashiers` (
  ...
  `LastName` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
INSERT INTO `cashiers` VALUES (1,'–ê–ª–∏–Ω–∞','–ì–∞–ª–∫–∏–Ω–∞','CinemaCashier1',_binary 'íπâ\¬CäÜ(d,nûŒç$0',0),(2,'–í–ª–∞–¥–∏—Å–ª–∞–≤','–í–µ–Ω–≥–ª–∏–Ω—Å–∫–∏–π','CinemaCashier2',_binary '3\≈˘\ﬁ\€(\÷Múkh±\Ï\‚?\„',0),(3,'–ò–ª—å—è','–≠–∫–∫–µ—Ä—Ç','CinemaAdmin',_binary '∑\¬x≥n˙w\ÕøAÀµOö',1);
